...
export const MOCK_STANDINGS: TeamStandingsResponse = {
  ...
  standings: [
    {
      ...
      gamesPlayed: 81,
      goalDifferential: 49,
      goalDifferentialPctg: 0.604938,
      goalAgainst: 229,
      goalFor: 278,
      goalsForPctg: 3.432099,
      homeGamesPlayed: 40,
      ...
      losses: 23,
      otLosses: 4,
      placeName: { default: 'NY Rangers' },
      pointPctg: 0.691358,
      points: 112,
      regulationPlusOtWinPctg: 0.617284,
      regulationPlusOtWins: 50,
    ...
    },
    {
      ...
      pointPctg: 0.68125,
      points: 109,
      regulationPlusOtWinPctg: 0.6125,
      regulationPlusOtWins: 49,
      regulationWinPctg: 0.5375,
      regulationWins: 43,
      roadGamesPlayed: 39,
      ...
      teamCommonName: { default: 'Hurricanes' },
    ...
    },
    {
      ...
      gamesPlayed: 80,
      goalDifferential: 47,
      goalDifferentialPctg: 0.5875,
      goalAgainst: 219,
      goalFor: 266,
      goalsForPctg: 3.325,
      homeGamesPlayed: 40,
      homeGoalDifferential: 29,
    ...
    },
    {
      ...
      gamesPlayed: 81,
      goalDifferential: 65,
      goalDifferentialPctg: 0.802469,
      goalAgainst: 198,
      goalFor: 263,
      goalsForPctg: 3.246914,
      homeGamesPlayed: 40,
      ...
      regulationPlusOtWinPctg: 0.592593,
      regulationPlusOtWins: 48,
      regulationWinPctg: 0.506173,
      regulationWins: 41,
      roadGamesPlayed: 41,
      roadGoalDifferential: 44,
      roadGoalsAgainst: 95,
      roadGoalsFor: 139,
      roadLosses: 11,
      roadOtLosses: 4,
      ...
      teamCommonName: { default: 'Panthers' },
    ...
    },
    {
      ...
      gamesPlayed: 80,
      goalDifferential: 55,
      goalDifferentialPctg: 0.6875,
      goalAgainst: 218,
      goalFor: 273,
      goalsForPctg: 3.4125,
      homeGamesPlayed: 40,
      homeGoalDifferential: 42,
      homeGoalsAgainst: 98,
      homeGoalsFor: 140,
      homeLosses: 9,
      homeOtLosses: 5,
    ...
    },
    {
      ...
      gamesPlayed: 80,
      goalDifferential: 57,
      goalDifferentialPctg: 0.7125,
      goalAgainst: 194,
      goalFor: 251,
      goalsForPctg: 3.1375,
      homeGamesPlayed: 39,
      homeGoalDifferential: 36,
      homeGoalsAgainst: 93,
      homeGoalsFor: 129,
      homeLosses: 11,
      homeOtLosses: 3,
    ...
    },
    {
      ...
      goalsForPctg: 3.7,
      homeGamesPlayed: 40,
      homeGoalDifferential: 57,
      homeGoalsAgainst: 111,
      homeGoalsFor: 168,
      homeLosses: 9,
      homeOtLosses: 1,
      homePoints: 61,
      homeRegulationPlusOtWins: 29,
      homeRegulationWins: 26,
      homeTies: 0,
      homeWins: 30,
      l10GamesPlayed: 10,
      l10GoalDifferential: -9,
      ...
      pointPctg: 0.65,
      points: 104,
      regulationPlusOtWinPctg: 0.5875,
      regulationPlusOtWins: 47,
      regulationWinPctg: 0.5125,
      regulationWins: 41,
      roadGamesPlayed: 40,
    ...
    },
    {
      ...
      gamesPlayed: 79,
      goalDifferential: 57,
      goalDifferentialPctg: 0.721519,
      goalAgainst: 225,
      goalFor: 282,
      goalsForPctg: 3.56962,
      homeGamesPlayed: 40,
      homeGoalDifferential: 57,
      homeGoalsAgainst: 104,
      homeGoalsFor: 161,
      homeLosses: 9,
      homeOtLosses: 4,
      homePoints: 58,
      ...
      pointPctg: 0.64557,
      points: 102,
      regulationPlusOtWinPctg: 0.582278,
      regulationPlusOtWins: 46,
      regulationWinPctg: 0.481013,
      regulationWins: 38,
      roadGamesPlayed: 39,
    ...
    },
    {
      ...
      gamesPlayed: 80,
      goalDifferential: 45,
      goalDifferentialPctg: 0.5625,
      goalAgainst: 252,
      goalFor: 297,
      goalsForPctg: 3.7125,
      homeGamesPlayed: 41,
      homeGoalDifferential: 15,
      homeGoalsAgainst: 141,
      homeGoalsFor: 156,
      homeLosses: 15,
      homeOtLosses: 4,
      homePoints: 48,
      ...
      pointPctg: 0.6375,
      points: 102,
      regulationPlusOtWinPctg: 0.5125,
      regulationPlusOtWins: 41,
      regulationWinPctg: 0.4125,
      regulationWins: 33,
      roadGamesPlayed: 39,
    ...
    },
    {
      ...
      pointPctg: 0.611111,
      points: 99,
      regulationPlusOtWinPctg: 0.54321,
      regulationPlusOtWins: 44,
      regulationWinPctg: 0.469136,
      regulationWins: 38,
      roadGamesPlayed: 40,
    ...
    },
    {
      ...
      gamesPlayed: 80,
      goalDifferential: 23,
      goalDifferentialPctg: 0.2875,
      goalAgainst: 260,
      goalFor: 283,
      goalsForPctg: 3.5375,
      homeGamesPlayed: 39,
      homeGoalDifferential: 32,
      homeGoalsAgainst: 117,
      homeGoalsFor: 149,
      homeLosses: 10,
      homeOtLosses: 5,
      homePoints: 53,
      ...
      teamCommonName: { default: 'Lightning' },
    ...
    },
    {
      ...
      gamesPlayed: 79,
      goalDifferential: 22,
      goalDifferentialPctg: 0.278481,
      goalAgainst: 237,
      goalFor: 259,
      goalsForPctg: 3.278481,
      homeGamesPlayed: 38,
      ...
      pointPctg: 0.594937,
      points: 94,
      regulationPlusOtWinPctg: 0.493671,
      regulationPlusOtWins: 39,
      regulationWinPctg: 0.417722,
      regulationWins: 33,
      roadGamesPlayed: 41,
      roadGoalDifferential: -12,
      roadGoalsAgainst: 141,
      roadGoalsFor: 129,
      roadLosses: 17,
      roadOtLosses: 6,
      roadPoints: 42,
      ...
      teamCommonName: { default: 'Golden Knights' },
    ...
    },
    {
      ...
      gamesPlayed: 80,
      goalDifferential: -13,
      goalDifferentialPctg: -0.1625,
      goalAgainst: 247,
      goalFor: 234,
      goalsForPctg: 2.925,
      homeGamesPlayed: 40,
      homeGoalDifferential: 11,
      homeGoalsAgainst: 116,
      homeGoalsFor: 127,
      homeLosses: 14,
      homeOtLosses: 2,
      homePoints: 50,
    ...
    },
    {
      ...
      pointPctg: 0.54375,
      points: 87,
      regulationPlusOtWinPctg: 0.425,
      regulationPlusOtWins: 34,
      regulationWinPctg: 0.375,
      regulationWins: 30,
      roadGamesPlayed: 40,
      roadGoalDifferential: -34,
      roadGoalsAgainst: 134,
      roadGoalsFor: 100,
      roadLosses: 19,
      roadOtLosses: 4,
      roadPoints: 38,
    ...
    },
    {
      ...
      gamesPlayed: 81,
      goalDifferential: -25,
      goalDifferentialPctg: -0.308642,
      goalAgainst: 259,
      goalFor: 234,
      goalsForPctg: 2.888889,
      homeGamesPlayed: 40,
      ...
      pointPctg: 0.537037,
      points: 87,
      regulationPlusOtWinPctg: 0.419753,
      regulationPlusOtWins: 34,
      regulationWinPctg: 0.37037,
      regulationWins: 30,
      roadGamesPlayed: 41,
      roadGoalDifferential: -13,
      roadGoalsAgainst: 136,
      roadGoalsFor: 123,
      roadLosses: 16,
      roadOtLosses: 7,
      roadPoints: 43,
    ...
    },
    {
      ...
      pointPctg: 0.5375,
      points: 86,
      regulationPlusOtWinPctg: 0.4375,
      regulationPlusOtWins: 35,
      regulationWinPctg: 0.3875,
      regulationWins: 31,
      roadGamesPlayed: 40,
      ...
      teamCommonName: { default: 'Penguins' },
    ...
    },
    {
      ...
      pointPctg: 0.506173,
      points: 82,
      regulationPlusOtWinPctg: 0.444444,
      regulationPlusOtWins: 36,
      regulationWinPctg: 0.395062,
      regulationWins: 32,
      roadGamesPlayed: 40,
      roadGoalDifferential: -10,
    ...
    },
    {
      ...
      gamesPlayed: 81,
      goalDifferential: -16,
      goalDifferentialPctg: -0.197531,
      goalAgainst: 279,
      goalFor: 263,
      goalsForPctg: 3.246914,
      homeGamesPlayed: 40,
      homeGoalDifferential: -19,
      homeGoalsAgainst: 147,
      homeGoalsFor: 128,
      homeLosses: 20,
      homeOtLosses: 3,
      homePoints: 37,
      ...
      pointPctg: 0.5,
      points: 81,
      regulationPlusOtWinPctg: 0.469136,
      regulationPlusOtWins: 38,
      regulationWinPctg: 0.407407,
      regulationWins: 33,
      roadGamesPlayed: 41,
    ...
    },
    {
      ...
      gamesPlayed: 79,
      goalDifferential: -16,
      goalDifferentialPctg: -0.202532,
      goalAgainst: 225,
      goalFor: 209,
      goalsForPctg: 2.64557,
      homeGamesPlayed: 41,
      ...
      pointPctg: 0.5,
      points: 79,
      regulationPlusOtWinPctg: 0.379747,
      regulationPlusOtWins: 30,
      regulationWinPctg: 0.341772,
      regulationWins: 27,
      roadGamesPlayed: 38,
      roadGoalDifferential: -12,
      roadGoalsAgainst: 108,
      roadGoalsFor: 96,
      roadLosses: 15,
      roadOtLosses: 7,
      roadPoints: 39,
    ...
    },
    {
      ...
      gamesPlayed: 79,
      goalDifferential: -20,
      goalDifferentialPctg: -0.253165,
      goalAgainst: 261,
      goalFor: 241,
      goalsForPctg: 3.050633,
      homeGamesPlayed: 39,
      homeGoalDifferential: -10,
      ...
      pointPctg: 0.487342,
      points: 77,
      regulationPlusOtWinPctg: 0.455696,
      regulationPlusOtWins: 36,
      regulationWinPctg: 0.379747,
      regulationWins: 30,
      roadGamesPlayed: 40,
      roadGoalDifferential: -10,
    ...
    },
    {
      ...
      pointPctg: 0.475,
      points: 76,
      regulationPlusOtWinPctg: 0.3875,
      ...
      teamCommonName: { default: 'Senators', fr: 'Sénateurs' },
    ...
    },
    {
      ...
      pointPctg: 0.46875,
      points: 75,
      regulationPlusOtWinPctg: 0.4125,
      ...
      teamCommonName: { default: 'Coyotes' },
      teamAbbrev: { default: 'ARI' },
    ...
    },
    {
      ...
      gamesPlayed: 80,
      goalDifferential: -51,
      goalDifferentialPctg: -0.6375,
      goalAgainst: 279,
      goalFor: 228,
      goalsForPctg: 2.85,
      homeGamesPlayed: 40,
      homeGoalDifferential: -19,
      homeGoalsAgainst: 134,
      homeGoalsFor: 115,
      homeLosses: 20,
      homeOtLosses: 4,
      homePoints: 36,
      ...
      pointPctg: 0.4625,
      points: 74,
      regulationPlusOtWinPctg: 0.325,
      regulationPlusOtWins: 26,
      regulationWinPctg: 0.25,
      regulationWins: 20,
      roadGamesPlayed: 40,
      roadGoalDifferential: -32,
    ...
    },
    {
      ...
      gamesPlayed: 81,
      goalDifferential: -66,
      goalDifferentialPctg: -0.814815,
      goalAgainst: 297,
      goalFor: 231,
      goalsForPctg: 2.851852,
      homeGamesPlayed: 40,
      homeGoalDifferential: -15,
      homeGoalsAgainst: 134,
      homeGoalsFor: 119,
      ...
      pointPctg: 0.395062,
      points: 64,
      regulationPlusOtWinPctg: 0.283951,
      regulationPlusOtWins: 23,
      regulationWinPctg: 0.246914,
      regulationWins: 20,
      roadGamesPlayed: 41,
      roadGoalDifferential: -51,
      roadGoalsAgainst: 163,
      roadGoalsFor: 112,
      roadLosses: 24,
      roadOtLosses: 7,
      roadPoints: 27,
    ...
    },
    {
      ...
      gamesPlayed: 81,
      goalDifferential: -94,
      goalDifferentialPctg: -1.160494,
      goalAgainst: 294,
      goalFor: 200,
      goalsForPctg: 2.469136,
      homeGamesPlayed: 41,
      ...
      pointPctg: 0.351852,
      points: 57,
      regulationPlusOtWinPctg: 0.308642,
      regulationPlusOtWins: 25,
      regulationWinPctg: 0.246914,
      regulationWins: 20,
      roadGamesPlayed: 40,
      roadGoalDifferential: -54,
    ...
    },
    {
      ...
      gameTypeId: 2,
      gamesPlayed: 79,
      goalDifferential: -106,
      goalDifferentialPctg: -1.341772,
      goalAgainst: 278,
      goalFor: 172,
      goalsForPctg: 2.177215,
      homeGamesPlayed: 40,
      ...
      pointPctg: 0.322785,
      points: 51,
      regulationPlusOtWinPctg: 0.278481,
      regulationPlusOtWins: 22,
      regulationWinPctg: 0.21519,
      regulationWins: 17,
      roadGamesPlayed: 39,
      roadGoalDifferential: -80,
      roadGoalsAgainst: 154,
      roadGoalsFor: 74,
      roadLosses: 31,
      roadOtLosses: 1,
    ...
    },
    {
      ...
      gameTypeId: 2,
      gamesPlayed: 80,
      goalDifferential: -139,
      goalDifferentialPctg: -1.7375,
      goalAgainst: 317,
      goalFor: 178,
      goalsForPctg: 2.225,
      homeGamesPlayed: 41,
      homeGoalDifferential: -71,
      homeGoalsAgainst: 164,
      homeGoalsFor: 93,
      homeLosses: 25,
      homeOtLosses: 5,
      homePoints: 27,
      ...
      pointPctg: 0.29375,
      points: 47,
      regulationPlusOtWinPctg: 0.225,
      regulationPlusOtWins: 18,
      regulationWinPctg: 0.175,
      regulationWins: 14,
      roadGamesPlayed: 39,
      roadGoalDifferential: -68,
